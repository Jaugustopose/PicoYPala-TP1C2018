...
void* atender_accion_instancia(void* info) { //TODO: Ver tema de cuándo terminar este hilo (debería cerrarse al matar la instancia correspondiente? o no por posible reconexion?)
